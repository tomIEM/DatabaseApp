...
public class MessageDAO extends DAOBase{
    ...
    public static final String TABLE_CREATE = "CREATE TABLE " + TABLE_NAME + " (" + KEY + " INTEGER PRIMARY KEY AUTOINCREMENT, " + CONTENT + " TEXT, " + DATE + " DATE);";
    ...
    public Message get(long id) {
        ...
        Cursor query = mDb.rawQuery("select id as _id, content, date_creation from " + TABLE_NAME + " where id = ?", new String[]{String.valueOf(id)});
            ...
            Integer date_creation = query.getInt(2);
